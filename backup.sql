...
CREATE TABLE public.demo (
    ...
    itemclass character varying(5),
    itemname character varying(40) DEFAULT ' '::character varying NOT NULL,
    quantity integer DEFAULT 0 NOT NULL,
    price numeric(9,2) DEFAULT 0 NOT NULL,
    iteminfo character varying(30)
);
...
COPY public.customer_customer_demo (customerid, customertypeid) FROM stdin;
\.
...
COPY public.customer_demographics (customertypeid, customerdesc) FROM stdin;
\.
...
COPY public.demo (itemid, itemclass, itemname, quantity, price, iteminfo) FROM stdin;
1	811	Chai	39	18.00	811
2	111	Chang	17	19.00	111
3	120	Aniseed Syrup	13	10.00	120
4	220	Chef Anton's Cajun Seasoning	53	22.00	220
5	221	Chef Anton's Gumbo Mix	0	21.35	221
6	320	Grandma's Boysenberry Spread	120	25.00	320
7	370	Uncle Bob's Organic Dried Pears	15	30.00	370
8	320	Northwoods Cranberry Sauce	6	40.00	320
9	461	Mishi Kobe Niku	29	97.00	461
10	480	Ikura	31	31.00	480
11	540	Queso Cabrales	22	21.00	540
12	540	Queso Manchego La Pastora	86	38.00	540
13	680	Konbu	24	6.00	680
14	670	Tofu	35	23.25	670
15	620	Genen Shouyu	39	13.00	620
16	730	Pavlova	29	17.45	730
17	761	Alice Mutton	0	39.00	761
18	780	Carnarvon Tigers	42	62.50	780
19	830	Teatime Chocolate Biscuits	25	9.20	830
20	830	Sir Rodney's Marmalade	40	81.00	830
21	830	Sir Rodney's Scones	3	10.00	830
22	950	Gustaf's Knäckebröd	104	21.00	950
23	950	Tunnbröd	61	9.00	950
24	1011	Guaraná Fantástica	20	4.50	1011
25	1130	NuNuCa Nuß-Nougat-Creme	76	14.00	1130
26	1130	Gumbär Gummibärchen	15	31.23	1130
27	1130	Schoggi Schokolade	49	43.90	1130
28	1271	Rössle Sauerkraut	26	45.60	1271
29	1261	Thüringer Rostbratwurst	0	123.79	1261
30	1380	Nord-Ost Matjeshering	10	25.89	1380
31	1440	Gorgonzola Telino	0	12.50	1440
32	1440	Mascarpone Fabioli	9	32.00	1440
33	1540	Geitost	112	2.50	1540
34	1610	Sasquatch Ale	111	14.00	1610
35	1610	Steeleye Stout	20	18.00	1610
36	1780	Inlagd Sill	112	19.00	1780
37	1780	Gravad lax	11	26.00	1780
38	1810	Côte de Blaye	17	263.50	1810
39	1810	Chartreuse verte	69	18.00	1810
40	1980	Boston Crab Meat	123	18.40	1980
41	1980	Jack's New England Clam Chowder	85	9.65	1980
42	2051	Singaporean Hokkien Fried Mee	26	14.00	2051
43	2010	Ipoh Coffee	17	46.00	2010
44	2020	Gula Malacca	27	19.45	2020
45	2180	Rogede sild	5	9.50	2180
46	2180	Spegesild	95	12.00	2180
47	2230	Zaanse koeken	36	9.50	2230
48	2230	Chocolade	15	12.75	2230
49	2330	Maxilaku	10	20.00	2330
50	2330	Valkoinen suklaa	65	16.25	2330
51	2470	Manjimup Dried Apples	20	53.00	2470
52	2450	Filo Mix	38	7.00	2450
53	2461	Perth Pasties	0	32.80	2461
54	2560	Tourtière	21	7.45	2560
55	2560	Pâté chinois	115	24.00	2560
56	2650	Gnocchi di nonna Alice	21	38.00	2650
57	2650	Ravioli Angelo	36	19.50	2650
58	2780	Escargots de Bourgogne	62	13.25	2780
59	2840	Raclette Courdavault	79	55.00	2840
60	2840	Camembert Pierrot	19	34.00	2840
61	2920	Sirop d'érable	113	28.50	2920
62	2930	Tarte au sucre	17	49.30	2930
63	720	Vegie-spread	24	43.90	720
64	1250	Wimmers gute Semmelknödel	22	33.25	1250
65	220	Louisiana Fiery Hot Pepper Sauce	76	21.05	220
66	220	Louisiana Hot Spiced Okra	4	17.00	220
67	1610	Laughing Lumberjack Lager	52	14.00	1610
68	830	Scottish Longbreads	6	12.50	830
69	1540	Gudbrandsdalsost	26	36.00	1540
70	710	Outback Lager	15	15.00	710
71	1540	Flotemysost	26	21.50	1540
72	1440	Mozzarella di Giovanni	14	34.80	1440
73	1780	Röd Kaviar	101	15.00	1780
74	470	Longlife Tofu	4	10.00	470
75	1210	Rhönbräu Klosterbier	125	7.75	1210
76	2310	Lakkalikööri	57	18.00	2310
77	1220	Original Frankfurter grüne Soße	32	13.00	1220
\.
...
COPY public.us_states (stateid, statename, stateabbr, stateregion) FROM stdin;
1	Alabama	AL	south
2	Alaska	AK	north
3	Arizona	AZ	west
4	Arkansas	AR	south
...
--
-- Name: demo items_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.customer_demographics
    ADD CONSTRAINT pk_customer_demographics PRIMARY KEY (customertypeid);
...
ALTER TABLE ONLY public.customer_customer_demo
    ADD CONSTRAINT fk_customer_customer_demo_customer_demographics FOREIGN KEY (customertypeid) REFERENCES public.customer_demographics(customertypeid);
...
ALTER TABLE ONLY public.customer_customer_demo
    ADD CONSTRAINT fk_customer_customer_demo_customers FOREIGN KEY (customerid) REFERENCES public.customers(customerid);
...
ALTER TABLE ONLY public.employee_territories
    ADD CONSTRAINT fk_employee_territories_employees FOREIGN KEY (employeeid) REFERENCES public.employees(employeeid);
...
ALTER TABLE ONLY public.employee_territories
    ADD CONSTRAINT fk_employee_territories_territories FOREIGN KEY (territoryid) REFERENCES public.territories(territoryid);
